...
int main() {
    ...
    //T.remove("tributes");
    cout << "Value at 29 for H1 should be lidless. The actual value is "<<T.at(29,0) << endl;
    cout << T.tableSize(0) << endl;
    cout << T.size(0) << endl;
    
    //cout << "The size of H1 is" << T.size(0) << endl;
    //cout << "The capacity of H1 is" << T.tableSize(0) << endl;
    cout << "----------------------------------------------------\n" ;
    cout << "Original hash table\n" ;
    cout << "----------------------------------------------------\n" ;
    T.dump() ;
    HashTable S(T);
    cout << "HashTable S" << endl;
    S.dump();
    cout << "HashTable Q" << endl;
    HashTable Q(107);
    Q=T;
    Q.dump();
