...
private:
	...
	static void doAMPERSAND(Sally *Sptr);
	static void doAND(Sally *Sptr);
	static void doOR(Sally *Sptr);
	static void doNOT(Sally *Sptr);
	static void doEXCLAMATION(Sally *Sptr);
	static void doLESSTHAN(Sally *Sptr);
	static void doLESSTHANEQUAL(Sally *Sptr);
	static void doEQUIVALENCY(Sally *Sptr);
	static void doNOTEQUALS(Sally *Sptr);
	static void doGREATERTHANEQUAL(Sally *Sptr);
